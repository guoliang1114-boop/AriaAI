...
def test_revision_037_is_the_single_alembic_head() -> None:
    ...
    assert script.get_heads() == ["037_v1_37"]
    revision = script.get_revision("037_v1_37")
    assert revision is not None
    assert revision.down_revision == "036_v1_36"
