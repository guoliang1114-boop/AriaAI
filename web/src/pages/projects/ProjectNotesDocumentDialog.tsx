...
export function ProjectNotesDocumentDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-2xl border border-codex-line bg-white p-6 shadow-2xl">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h3 className="text-lg font-semibold text-codex-ink">{title}</h3>
        ...
        <div className="mt-5">
          <label className="block text-sm font-medium text-codex-ink-soft">
            {copy.documentName}
          </label>
          <input
            type="text"
            ...
            className="mt-2 w-full rounded-xl border border-codex-line bg-white px-4 py-3 text-sm text-codex-ink focus:outline-none focus:ring-2 focus:ring-primary/20"
            autoFocus
          />
        </div>
