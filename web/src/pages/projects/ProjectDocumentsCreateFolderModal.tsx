      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md m-4 p-6">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-bold text-codex-ink">
            {isZh ? "新建文件澶?" : "New Folder"}
          </h3>
          <button
            onClick={onClose}
            className="p-2 rounded-lg hover:bg-codex-bg-tint text-codex-ink-faint transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-codex-ink-soft mb-2">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-codex-bg-tint border border-codex-line rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
          />
        </div>
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-codex-accent text-white rounded-lg text-sm font-medium hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
