...
export const PROJECT_CHAT_COPY = {
  zh: {
    ...
    saveCompleteTitle: "已完成沉淀",
    saveCompleteHint: "现在可以刷新项目记忆，让刚保存的内容进入 AI 上下文；也可以打开项目记忆页继续提升到客户记忆。",
    refreshProjectMemory: "刷新项目记忆",
    openProjectMemory: "打开项目记忆",
    finishSave: "完成",
    memoryRefreshStarted: "项目记忆已刷新",
    memoryRefreshFailed: "刷新项目记忆失败",
  ...
  en: {
    ...
    saveCompleteTitle: "Saved into project context",
    saveCompleteHint: "Refresh project memory now so the saved content enters AI context, or open the memory page to promote it into client memory.",
    refreshProjectMemory: "Refresh project memory",
    openProjectMemory: "Open project memory",
    finishSave: "Done",
    memoryRefreshStarted: "Project memory refreshed",
    memoryRefreshFailed: "Failed to refresh project memory",
