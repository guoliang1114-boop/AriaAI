...
- `ensure_db.py` 幂等注入版本升级公告（如 Kimi K2.6 升级通知、V0.0.2 发布通知）。
...
2026-04-23 已发布 `V0.0.2`，当前版本完成了以下关键闭环：

- Skill 从 Skill 列表进入项目/客户空间的一等启动入口，执行结果可沉淀为项目资产。
- 数字化战略 Skill 支持执行清单、日志明细、生成物附件，并强制使用 `digital-strategy` PPT 模板复制原型页，保留模板视觉。
