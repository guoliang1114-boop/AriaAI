...
| 迁移治理 | ✅ 已完成基础闭环 | 已接入部署脚本和设置页，最新 010_v1_10 |
...
**记忆版本化深化 + 任务治理服务端化 + Welcome 行动化**

优先级：

1. **会前简报深化**（P0）：加入 AI 优化版、会议类型、最近沟通来源和一键带入 Chat
2. **降低干系人捕获摩擦**（P0）：聊天中提到人名建议加入干系人
3. **用户验证**（P0）：找 5 个真实顾问在真实工作中使用北极星场景
4. 记忆快照 diff 视图深化和更细的审计说明
5. Memory Operations 服务端统计接口与批量治理
6. 后端大路由拆分（projects / clients / skills 子路由）
7. 安全基线：Markdown/XSS 系统复核、管理员接口权限

详细计划见 [05-迭代计划](05-迭代计划.md)，战略背景见 [03-产品战略方向](03-产品战略方向.md)。
