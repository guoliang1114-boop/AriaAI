...
Status labels describe the document, not a released version: **Contract** documents implemented behavior with historical sections; **Plan** describes direction and may include completed phases; **Historical** records an earlier iteration; **Current work** covers changes still awaiting release. Use [the acceptance record](23-2026-09-19全量推进验收.md) for actual validation and deployment evidence.
