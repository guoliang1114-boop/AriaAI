    ...
    <div className="frame-codex" style={{ flexDirection: "column" }}>
      ...
      <header style={{ padding: "0 28px", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "stretch", height: 56, flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "5px 10px", fontSize: 12, border: "1px solid var(--line)", borderRadius: "var(--r-sm)", color: "var(--ink-mute)", width: 200 }}>
            <I name="search" size={12} stroke={1.5}/>
            <span>项目内搜索</span>
            <span style={{ marginLeft: "auto", color: "var(--ink-faint)", fontSize: 10.5 }}>⌘K</span>
          </div>
      ...
      <div style={{ height: "100%", overflow: "hidden", padding: "24px 40px 32px", display: "grid", gridTemplateColumns: "1fr 320px", gap: 20, minWidth: 0 }}>
        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <CxPanel title="项目团队">
            ...
            <button style={{ width: "100%", marginTop: 8, padding: "7px 10px", fontSize: 12, color: "var(--ink-mute)", border: "1px dashed var(--line-strong)", borderRadius: "var(--r-sm)" }}>+ 添加成员</button>
          </CxPanel>
        </aside>
      </div>
    </CxProjectShell>
